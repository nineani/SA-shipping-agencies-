        ...
        <div class="inner join_section">
            ...
            <nav class="inner_nav">
                <ul>
                    ...
                    <li class="active"><a href="../manager/shipping_list_delete.jsp" class="inner_nav_link">배송대행 취소내역</a></li>
                </ul>
            </nav> <!-- 부메뉴 닫음 -->

            <!-- 콘텐츠 영역 -->
            <article class="section_info">
                <h2 class="sinfo_tit">배송대행 취소내역</h2>
				...
				<%
					...
					ArrayList<Item> list = aitemlist.getdelList(pageNumber);
				...
				%>
                    <tr>
                        ...
                        <td class="btn_wrap">
                            <p class="point_t"><input type="button" class="btn_custom" value="취소하기" onClick="location.href='shipping_delete.jsp?p_num=<%=list.get(i).getP_num()%>'"></p>
                        </td>
                    </tr>
                    <%
							}
                ...
                <%
					...
					%>
						<div class="btn_wrap both">
							<input type="button" class="btn_custom" value="이전" onclick="location.href='shipping_list_delete.jsp?pageNumber=<%=pageNumber -1 %>'">
						</div>
					<% 
						} if(aitemlist.nextPage(pageNumber + 1)) {
					%>
						<div class="btn_wrap both">
							<input type="button" class="btn_custom" value="다음" onclick="location.href='shipping_list_delete.jsp?pageNumber=<%=pageNumber +1 %>'">
						</div>
					<%
						}
					%>
